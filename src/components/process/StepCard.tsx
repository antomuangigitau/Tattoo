const StepCard = ({
  ...
  return (
    <div className="relative mb-32 last:mb-0">
      ...
      {!isLast && (
        <div
          className={`absolute w-0.5 h-32 bg-red-600 ${
            isEven ? "left-4 md:left-auto md:right-1/4" : "left-4 md:left-1/4"
          } top-full z-0`}
          style={{
        ...
        <div className="relative md:w-1/2">
          ...
          <div
            className={`absolute -top-3 ${
              isEven ? "md:-right-3 -right-3" : "md:-left-3 -left-3"
          ...
          <div
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              {/* Decorative small icon on right */}
